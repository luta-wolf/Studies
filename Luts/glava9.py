...
string = ''
string2 = '2'
print(bool(string), bool(string2)) # Пустая строка False, а непустая True
if string: # == if string != ''
    print(True)
else:
    print(False)
...
#1 Присваивание создает ссылки, а не копии
L = [1, 2, 3]
m = ['X', L, 'Y'] # Встраивание ссылки на L
print(L, m)
L[1] = 0 # Изменяет также и М
print(L, m)
L = [1, 2, 3]
m = ['X', L[:], 'Y'] # Встраивание копии L (или list(L) , или L.сору())
print(L, m)
L[1] = 0 # Изменяет только L, но не М
print(L, m)
print('=' * 10)
#2 Повторение добавляет один уровень глубины
l = [4, 5, 6]
x = l * 4
y = [l] * 4
print(x)
...
# 3 Остерегайтесь циклических структур данных
l = ['grail']
l.append(l) # Добавление ссылки на тот же самый объект создает цикл в объекте: [. ..]
print(l)
l.append('not')
print(l)
# 4 Неизменяемые типы нельзя модифицировать на месте
t = (1, 2, 3)
print(t)
# t[2] = 4 # Ошибка!
t = t[:2] + (4,) # Нормально
...
t = (4, 5, 6)
print(len(t))
t = (1,) + t[1:] # одноэлементные кортежи требуют хвостовой запятой
print(t)
print('-' * 10)
t = (4, 5, 6)
lst = list(t)
